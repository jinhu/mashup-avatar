...
import dev.game.legend.avatar.client.MyRequestFactory.HelloWorldRequest;
import dev.game.legend.avatar.client.MyRequestFactory.MessageRequest;
import dev.game.legend.avatar.shared.MessageProxy;
...
public class AvatarWidget extends Composite {
  ...
  interface AvatarUiBinder extends UiBinder<Widget, AvatarWidget> {
  }

  private static AvatarUiBinder uiBinder = GWT.create(AvatarUiBinder.class);
