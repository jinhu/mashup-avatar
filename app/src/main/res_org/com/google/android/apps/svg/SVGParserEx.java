...
//public class SVGParserEx extends SVGParser {
//    public static Path m2015a(String svgData) {
//        return null;//parse(new ByteArrayInputStream(svgData.getBytes()), 0, 0, false);
//    }
//
//    public static SVG getSVGFromInputStream(InputStream inputStream, Integer num, Integer num2, boolean z) {
//        return null;//parse(inputStream, num, num2, null, null, z);
//    }
//
