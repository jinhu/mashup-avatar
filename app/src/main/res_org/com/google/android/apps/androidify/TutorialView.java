...
//    }
//
//    public void addTransition(float f, float f2, dm dmVar, String str, boolean z) {
...
//        this.f954h.setColor(al.ANDROID_COLOR.intValue());
...
//        return this.f949c.size() > 0 ? ((C0222do) this.f949c.get(this.f951e)).hidden : false;
//    }
//
...
//                                f = c0222do.y - (((float) bitmap.getHeight()) / 2.0f);
//                                break;
...
//                                f = (c0222do.y + this.f952f) + a2;
//                                break;
//                            case cm.HListView_hlv_footerDividersEnabled /*4*/:
//                                f2 = c0222do.f1626a - (((float) bitmap.getWidth()) / 2.0f);
//                                f = ((c0222do.y - this.f952f) - ((float) bitmap.getHeight())) + a2;
//                                break;
...
//                            this.f958l = (((float) getWidth()) - this.f954h.measureText(c0222do.mtext)) / 2.0f;
//                        }
//                        f = (float) (getWidth() / 2);
//                        f2 = (((float) getHeight()) - this.f957k) - c0222do.height;
//                        if (a < 1.0f) {
//                            canvas.scale(a, a, f, f2);
//                        }
//                        canvas.drawText(c0222do.mtext, this.f958l, (((float) getHeight()) - this.f957k) - c0222do.height, this.f954h);
//                        canvas.restore();
//                    }
//                    invalidate();
//                }
