...
class PaperEngine extends Engine implements OnSharedPreferenceChangeListener {
    GestureDetector f1673a;
    final /* synthetic */ LiveWallpaper f1674b;
    private final Handler f1675c;
    private boolean f1676d;
    private AndroidDrawer f1677e;
    private AndroidDrawer f1678f;
    private AssetDatabase f1679g;
    ...
    private PaperEngine(LiveWallpaper liveWallpaper) {
    ...
    private AndroidConfig m1999a() {
        ...
        if (!"saved".equals(this.f1691s.getString("wallpaper_source", "saved")) || this.f1694v == null) {
            ...
            try {
                androidConfigVar.getInstance(this.f1674b.getApplicationContext(), LiveWallpaper.f1669a[nextInt]);
    ...
    private void m2005d() {
        ...
        if (LiveWallpaper.f1672d) {
            ...
            this.f1678f.setAndroidConfig(m1999a(), this.f1679g);
            this.f1678f.setBackgroundColor(m2003b());
            this.f1678f.m1845a(m2004c());
            this.f1678f.rescale();
            AndroidDrawer androidDrawerVar = this.f1677e;
            this.f1677e = this.f1678f;
            this.f1678f = androidDrawerVar;
        }
    ...
    public void onCreate(SurfaceHolder surfaceHolder) {
        ...
        this.f1679g = new AssetDatabase(this.f1674b, this.f1674b.getAssets(), this.f1674b.getResources());
        ...
        this.f1677e = new AndroidDrawer(this.f1674b.getApplicationContext());
        this.f1678f = new AndroidDrawer(this.f1674b.getApplicationContext());
        this.f1677e.setAndroidConfig(m1999a(), this.f1679g);
        this.f1677e.setBackgroundColor(m2003b());
        this.f1677e.m1845a(new StructOfFloats(2.0f, -0.8f, 2.0f, -10, true, 5.0f, 15000, 45));
