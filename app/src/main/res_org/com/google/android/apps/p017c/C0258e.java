...
class C0258e {
    ...
    void m2080a(byte b, OutputStream outputStream) {
    ...
    void m2082a(int i, OutputStream outputStream) {
        int i2;
        int i3 = 0;
        this.f1780j = i;
        this.f1779i = false;
    ...
    void m2085b(int i, OutputStream outputStream) {
    ...
    void m2086b(OutputStream outputStream) {
    ...
    void m2087c(OutputStream outputStream) {
        if (this.f1786p > 0) {
