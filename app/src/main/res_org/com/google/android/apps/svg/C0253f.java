...
//            z = false;
//        }
//        Float c = SVGParserEx.m2030g("opacity", attributes);
//        if (c != null) {
//            m2037a(c);
//            return z;
...
//        }
//        m2038a(attributes, b);
//        Float c = SVGParserEx.m2030g("stroke-width", attributes);
//        if (c != null) {
...
//        if (this.f1726n) {
//            if (str2.equals("rect")) {
//                c = SVGParserEx.m2030g("x", attributes);
//                if (c == null) {
//                    c = Float.valueOf(0.0f);
//                }
//                c2 = SVGParserEx.m2030g("y", attributes);
//                if (c2 == null) {
//                    c2 = Float.valueOf(0.0f);
//                }
//                c3 = SVGParserEx.m2030g("width", attributes);
//                SVGParserEx.m2030g("height", attributes);
//                this.f1717e = new RectF(c.floatValue(), c2.floatValue(), c.floatValue() + c3.floatValue(), c2.floatValue() + c3.floatValue());
//            }
//        } else if (str2.equals("svg")) {
//            c3 = SVGParserEx.m2030g("width", attributes);
//            r3 = SVGParserEx.m2030g("height", attributes);
//            if (c3 == null || r3 == null) {
//                String a = SVGParserEx.m2028f("viewBox", attributes);
//                if (a != null) {
...
//            if (str2.equals("g")) {
//                String a2 = SVGParserEx.m2028f("id", attributes);
...
//                    this.f1725m++;
//                }
//                if ("none".equals(SVGParserEx.m2028f("display", attributes)) && !this.f1724l) {
//                    this.f1724l = true;
//                    this.f1725m = 1;
//                }
//                c = SVGParserEx.m2030g("opacity", attributes);
//                if (c != null) {
//                    this.f1727o = c;
//                }
...
//                c = SVGParserEx.m2030g("y", attributes);
//                Float valueOf2 = c == null ? Float.valueOf(0.0f) : c;
//                Float c4 = SVGParserEx.m2030g("width", attributes);
//                Float c5 = SVGParserEx.m2030g("height", attributes);
//                m2041c(attributes);
...
//                c2 = SVGParserEx.m2030g("x1", attributes);
//                r3 = SVGParserEx.m2030g("x2", attributes);
//                c3 = SVGParserEx.m2030g("y1", attributes);
//                Float c6 = SVGParserEx.m2030g("y2", attributes);
//                if (m2040b(attributes)) {
//                    m2041c(attributes);
...
//                c = SVGParserEx.m2030g("cx", attributes);
//                c2 = SVGParserEx.m2030g("cy", attributes);
//                c3 = SVGParserEx.m2030g("r", attributes);
...
//                c = SVGParserEx.m2030g("cx", attributes);
//                c2 = SVGParserEx.m2030g("cy", attributes);
//                c3 = SVGParserEx.m2030g("rx", attributes);
//                r3 = SVGParserEx.m2030g("ry", attributes);
