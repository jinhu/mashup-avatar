...
public class AssetDatabase {
    ...
    private void m1650a(List<PartConfig> list, Map map) {
        map.clear();
    ...
    private void m1653m() throws IOException {
        List list;
        HashMap hashMap;
    ...
    public PartConfig m1655a(String str, String str2) {
        return str.equals("beard") ? m1678g(str2) : str.equals("face") ? m1682i(str2) : str.equals("hat") ? m1680h(str2) : str.equals("body") ? m1684j(str2) : str.equals("glasses") ?
    ...
    public dev.game.legend.svgandroid.SVG getSvgFromResource(int i) {
        return getSvgFromResource(i, null, null);
    }

    public dev.game.legend.svgandroid.SVG getSvgFromResource(int i, Integer source, Integer replace) {
        try {
            return SVGParser.getSVGFromInputStream(this.mResources.openRawResource(i), source, replace);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public PartConfig m1667b(String str) {
        return (PartConfig) this.f1149m.get(str);
    }
    ...
    public SVG m1669b(PartConfig aPartConfigVar, AndroidConfig aAndroidConfigVar) {
        if (!aPartConfigVar.f1132e) {
    ...
    public PartConfig m1678g(String str) {
        return (PartConfig) this.f1154r.get(str);
    }
    ...
    public PartConfig m1680h(String str) {
        return (PartConfig) this.f1155s.get(str);
    }
    ...
    public PartConfig m1682i(String str) {
        return (PartConfig) this.f1156t.get(str);
    }
    ...
    public PartConfig m1684j(String str) {
        return (PartConfig) this.f1157u.get(str);
    }
    ...
    public PartConfig m1686k(String str) {
        return (PartConfig) this.f1158v.get(str);
    }
