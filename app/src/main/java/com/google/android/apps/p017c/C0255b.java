...
public class C0255b {
    ...
    public static byte[] m2068a(String str) throws Throwable {
        return C0255b.m2069a(str, 0);
    }

    public static byte[] m2069a(String str, int i) throws Throwable {
        byte[] bytes;
    ...
    static int m2072b(byte[] bArr, int i, byte[] bArr2, int i2, int i3) {
        if (bArr == null) {
...
//                    try {
//                        gZIPOutputStream = new GZIPOutputStream(c0256c);
...
//                        } catch (Exception e8) {
//                        }
//                        return null;//byteArrayOutputStream2.toByteArray();
...
//        }
    ...
    static byte[] m2075b(byte[] bArr, byte[] bArr2, int i, int i2) {
        C0255b.m2070a(bArr2, 0, i, bArr, 0, i2);
        return bArr;
    }

    static final byte[] m2076c(int i) {
        return (i & 16) == 16 ? f1758e : (i & 32) == 32 ? f1760g : f1756c;
    }

    public static byte[] m2077c(byte[] bArr, int i, int i2, int i3) throws IOException {
        if (bArr == null) {
