...
class C0201y extends SQLiteOpenHelper {
    ...
    private final AndDatabase f727b;

    C0201y(Context context, String str, int i, AndDatabase aAndDatabase) {
        super(context, str, null, i);
        this.f726a = i;
        this.f727b = aAndDatabase;
    }

    private void m1291a(SQLiteDatabase sQLiteDatabase, int i) throws Throwable {
    ...
    private void m1295e(SQLiteDatabase sQLiteDatabase) throws Throwable {
        Cursor query;
        Cursor query2;
        SQLiteException e;
        Throwable th;
    ...
    private void m1296f(SQLiteDatabase sQLiteDatabase) throws Throwable {
        SQLiteException e;
        Cursor cursor;
        Throwable th;
        Cursor query;
        try {
            ...
            try {
                ...
                if (sQLiteDatabase.inTransaction()) {
                    AndDatabase.m1261f(sQLiteDatabase);
                }
            } catch (SQLiteException e2) {
                e = e2;
                cursor = query;
    ...
    void m1297a(SQLiteDatabase sQLiteDatabase) {
        ...
        sQLiteDatabase.execSQL(AndDatabase.f708p);
        sQLiteDatabase.execSQL("DROP TABLE IF EXISTS custom_var_cache;");
        sQLiteDatabase.execSQL(AndDatabase.f709q);
        for (int i = 1; i <= 5; i++) {
            ContentValues contentValues = new ContentValues();
    ...
    public void onCreate(SQLiteDatabase sQLiteDatabase) {
        ...
        sQLiteDatabase.execSQL(AndDatabase.f706n);
        ...
        sQLiteDatabase.execSQL(AndDatabase.f707o);
        if (this.f726a > 1) {
