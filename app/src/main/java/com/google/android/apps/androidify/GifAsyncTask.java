...
class GifAsyncTask extends AsyncTask {
    final /* synthetic */ GifActivity gitActivity;

    GifAsyncTask(GifActivity gifActivity) {
        this.gitActivity = gifActivity;
    }

    protected File m1892a(Void[] voidArr) {
        try {
            this.gitActivity.f880c = System.currentTimeMillis();
            ...
            for (long j = 0; j < 2000; j += 50) {
                ...
                this.gitActivity.mAndroidDrawer.m1841a(this.gitActivity.f879b, (double) j);
                this.gitActivity.mAndroidDrawer.m1837a(canvas);
            }
            c0254a.m2054b();
            this.gitActivity.m1494a();
    ...
    protected void m1893a(File file) {
        ...
        this.gitActivity.startActivity(Intent.createChooser(intent, "Share"));
    }
