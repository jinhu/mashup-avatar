...
public class AndroidViewAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (this.f1274c != null) {
            ...
            this.mMainView.m1712a(this.mAccessoryTypeContainer, vectorView, this.f1277f, i);
        } else {
            this.mMainView.m1708a(vectorView, this.mAccessoryTypeContainer, this.f1276e, i);
        }
        vectorView.setTag(Integer.valueOf(i));
        if (this.mAccessoryTypeContainer != null) {
            vectorView.setSelected(this.mMainView.m1715a(this.mAccessoryTypeContainer, i));
            if (i == 0) {
                vectorView.setContentDescription("no " + this.mAccessoryTypeContainer.f1268t);
            } else {
                vectorView.setContentDescription(this.mAccessoryTypeContainer.f1268t + " " + i);
            }
        } else {
