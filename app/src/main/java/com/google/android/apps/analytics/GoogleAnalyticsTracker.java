...
public class GoogleAnalyticsTracker {
    private static GoogleAnalyticsTracker f650a;
    ...
    static {
        f650a = new GoogleAnalyticsTracker();
    }
    ...
    private GoogleAnalyticsTracker() {
        ...
        this.mTracker = new GoogleTracker(this);
    }

    public static GoogleAnalyticsTracker m1177a() {
        return f650a;
    }
    ...
    private void m1180e() {
        if (this.f661l >= 0 && this.f670u.postDelayed(this.mTracker, (long) (this.f661l * 1000)) && this.f651b) {
    ...
    private void m1181f() {
        if (this.f670u != null) {
            this.f670u.removeCallbacks(this.mTracker);
        }
    }
    ...
    void m1186a(String str, int i, Context context, AndRepo aAndRepo, C0182f c0182f, boolean z) {
        m1187a(str, i, context, aAndRepo, c0182f, z, new C0187k(this));
    }

    void m1187a(String str, int i, Context context, AndRepo aAndRepo, C0182f c0182f, boolean z, C0183g c0183g) {
        this.f656g = str;
        if (context == null) {
    ...
    void m1188a(String str, int i, Context context, boolean z) {
        ...
        C0182f c0195s;
        if (this.f662m == null) {
            c0200x = new AndDatabase(context);
