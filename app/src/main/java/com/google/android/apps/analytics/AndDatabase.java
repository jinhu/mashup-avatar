...
class AndDatabase implements AndRepo {
     static final String f706n;
     static final String f707o;
     static final String f708p;
     static final String f709q;
     static final String f710r;
     static final String f711s;
     static final String f712t;
     C0201y f713a;
     int f714b;
     long f715c;
     long f716d;
    ...
    AndDatabase(Context context) {
        this(context, "google_analytics.db", 5);
    }

    AndDatabase(Context context, String str, int i) {
        this.f723k = 100;
    ...
    void m1257a(C0184h c0184h, SQLiteDatabase sQLiteDatabase, boolean z) throws Throwable {
        if (!c0184h.m1175m()) {
    ...
    private boolean m1259a(SQLiteDatabase sQLiteDatabase, ContentValues contentValues) {
        try {
            ...
            return !sQLiteDatabase.inTransaction() || AndDatabase.m1261f(sQLiteDatabase);
        } catch (SQLiteException e) {
            Log.e("GoogleAnalyticsTracker", e.toString());
            return (!sQLiteDatabase.inTransaction() || AndDatabase.m1261f(sQLiteDatabase)) ? false : false;
        } catch (Throwable th) {
            if (sQLiteDatabase.inTransaction() && !AndDatabase.m1261f(sQLiteDatabase)) {
                return false;
            }
        }
    ...
    static boolean m1261f(SQLiteDatabase sQLiteDatabase) {
        try {
     ...
     ab m1262g(SQLiteDatabase sQLiteDatabase) throws Throwable {
    ...
    ac m1270a(long j, SQLiteDatabase sQLiteDatabase) throws Throwable {
        SQLiteException e;
        Throwable th;
        Cursor query;
        try {
            ...
            try {
                if (query.moveToFirst()) {
                    ac a = new ConfugAe(query.getString(query.getColumnIndex("order_id")), query.getDouble(query.getColumnIndex("tran_totalcost"))).m1128a(query.getString(query.getColumnIndex("tran_storename"))).m1127a(query.getDouble(query.getColumnIndex("tran_totaltax"))).m1129b(query.getDouble(query.getColumnIndex("tran_shippingcost"))).m1126a();
                    if (query == null) {
                        return a;
                    }
                    query.close();
    ...
    C0181e m1271a(SQLiteDatabase sQLiteDatabase) throws Throwable {
        SQLiteException e;
        Throwable th;
            ...
            try {
                ...
                try {
                    ...
                    if (writableDatabase.inTransaction()) {
                        AndDatabase.m1261f(writableDatabase);
                    }
                } catch (SQLiteException e) {
    ...
    public C0184h[] m1278a(int i, SQLiteDatabase sQLiteDatabase, int i2) throws Throwable {
        SQLiteException e;
        Cursor cursor;
        Throwable th;
    ...
    public C0189m[] m1279a() throws Throwable {
        return m1283b(1000);
    }
    ...
    C0192p m1281b(long j, SQLiteDatabase sQLiteDatabase) throws Throwable {
        Cursor query;
        SQLiteException e;
        Cursor cursor;
        Throwable th;
    ...
    public void m1282b(SQLiteDatabase sQLiteDatabase) throws Throwable {
        Cursor query;
        SQLiteException e;
        Throwable th;
        try {
    ...
    public C0189m[] m1283b(int i) throws Throwable {
        Cursor query;
        SQLiteException e;
        Throwable th;
        List arrayList = new ArrayList();
    ...
    C0181e m1284c(long j, SQLiteDatabase sQLiteDatabase) throws Throwable {
        SQLiteException e;
        Throwable th;
        C0181e c0181e = new C0181e();
        Cursor query;
    ...
    ab m1287d(SQLiteDatabase sQLiteDatabase) throws Throwable {
        Cursor query;
        SQLiteException e;
        Cursor cursor;
        Throwable th;
    ...
    @Override
    public void m1208a(int i) {

    }

    @Override
    public void m1209a(long j) {

    }

    @Override
    public void m1210a(C0184h c0184h) {

    }

    @Override
    public void m1211a(boolean z) {

    }

    @Override
    public C0189m[] m1212a() {
        return new C0189m[0];
    }
