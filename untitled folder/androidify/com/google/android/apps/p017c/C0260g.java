...
public class C0260g {
    ...
    public C0260g(View view, C0203m c0203m, Picture picture, Picture picture2, long j) {
        this.f1803a = false;
        this.f1804b = false;
    ...
    private MotionEvent m2099a(String str, long j) {
        ...
        C0176a.m1106c("Obtained MotionEvent: " + obtain.toString());
        return obtain;
    }
    ...
    public void m2108a(InputStream inputStream) {
        ...
        try {
            ...
            if (readLine != null) {
                ...
                j3 = a.getEventTime();
                C0176a.m1106c("Time correction for motion events replay is " + j);
            }
            ...
            while (str != null) {
                ...
                if (a2.getAction() == 0 && motionEvent != null) {
                    C0176a.m1106c("Found down action, creating motion action between pointer positions.");
                ...
                C0176a.m1106c("  Playing event: " + a2.toString() + " with delay " + j4);
