...
class C0253f extends DefaultHandler {
    ...
    private boolean m2039a(Attributes attributes) {
        boolean z = true;
        if ("none".equals(C0250c.m2028f("display", attributes))) {
            return false;
        }
        if (this.f1723k) {
        ...
        Integer b = C0250c.m2031h("fill", attributes);
        if (b != null) {
            m2038a(attributes, b);
            this.f1715c.setStyle(Style.FILL);
        } else if (C0250c.m2028f("fill", attributes) == null && C0250c.m2028f("stroke", attributes) == null) {
            this.f1715c.setStyle(Style.FILL);
            this.f1715c.setColor(-16777216);
        } else {
            z = false;
        }
        Float c = C0250c.m2030g("opacity", attributes);
        if (c != null) {
            m2037a(c);
            return z;
    ...
    private boolean m2040b(Attributes attributes) {
        if (this.f1723k || "none".equals(C0250c.m2028f("display", attributes))) {
            return false;
        }
        Integer b = C0250c.m2031h("stroke", attributes);
        if (b == null) {
            return false;
        }
        m2038a(attributes, b);
        Float c = C0250c.m2030g("stroke-width", attributes);
        if (c != null) {
            this.f1715c.setStrokeWidth(c.floatValue());
        }
        String a = C0250c.m2028f("stroke-linecap", attributes);
        if ("round".equals(a)) {
        ...
        a = C0250c.m2028f("stroke-linejoin", attributes);
        if ("miter".equals(a)) {
    ...
    private void m2041c(Attributes attributes) {
        String a = C0250c.m2028f("transform", attributes);
        this.f1728p = a != null;
        if (this.f1728p) {
            Matrix b = C0250c.m2027f(a);
            this.f1714b.save();
    ...
    public void startElement(String str, String str2, String str3, Attributes attributes) {
        ...
        if (this.f1726n) {
            if (str2.equals("rect")) {
                c = C0250c.m2030g("x", attributes);
                if (c == null) {
                    c = Float.valueOf(0.0f);
                }
                c2 = C0250c.m2030g("y", attributes);
                if (c2 == null) {
                    c2 = Float.valueOf(0.0f);
                }
                c3 = C0250c.m2030g("width", attributes);
                C0250c.m2030g("height", attributes);
                this.f1717e = new RectF(c.floatValue(), c2.floatValue(), c.floatValue() + c3.floatValue(), c2.floatValue() + c3.floatValue());
            }
        } else if (str2.equals("svg")) {
            c3 = C0250c.m2030g("width", attributes);
            r3 = C0250c.m2030g("height", attributes);
            if (c3 == null || r3 == null) {
                String a = C0250c.m2028f("viewBox", attributes);
                if (a != null) {
            ...
            if (str2.equals("g")) {
                String a2 = C0250c.m2028f("id", attributes);
                ...
                if ("none".equals(C0250c.m2028f("display", attributes)) && !this.f1724l) {
                    this.f1724l = true;
                    this.f1725m = 1;
                }
                c = C0250c.m2030g("opacity", attributes);
                if (c != null) {
                    this.f1727o = c;
                }
                ...
                c = C0250c.m2030g("y", attributes);
                Float valueOf2 = c == null ? Float.valueOf(0.0f) : c;
                Float c4 = C0250c.m2030g("width", attributes);
                Float c5 = C0250c.m2030g("height", attributes);
                m2041c(attributes);
                ...
                c2 = C0250c.m2030g("x1", attributes);
                r3 = C0250c.m2030g("x2", attributes);
                c3 = C0250c.m2030g("y1", attributes);
                Float c6 = C0250c.m2030g("y2", attributes);
                if (m2040b(attributes)) {
                    m2041c(attributes);
                ...
                c = C0250c.m2030g("cx", attributes);
                c2 = C0250c.m2030g("cy", attributes);
                c3 = C0250c.m2030g("r", attributes);
                ...
                c = C0250c.m2030g("cx", attributes);
                c2 = C0250c.m2030g("cy", attributes);
                c3 = C0250c.m2030g("rx", attributes);
                r3 = C0250c.m2030g("ry", attributes);
                ...
                C0252e d = C0250c.m2026e("points", attributes);
                if (d != null) {
                    Path path = new Path();
                ...
                Path c7 = C0250c.m2029g(C0250c.m2028f("d", attributes));
                m2041c(attributes);
                if (m2039a(attributes)) {
                    m2036a(c7);
                ...
                C0176a.m1106c("UNRECOGNIZED SVG COMMAND: " + str2);
            }
        }
    }
}
