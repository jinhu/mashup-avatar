...
public class az implements Comparable {
    ...
    public static az m1762a() {
        ...
        azVar.m1803g(1.0f);
        azVar.m1806h(1.0f);
        azVar.m1782b(al.f1191b.intValue());
        azVar.m1775a(al.f1190a.intValue());
        return azVar;
    }

    private boolean m1763a(ag agVar) {
        return (agVar == null || agVar.m1643b() == null) ? false : agVar.m1643b().equals("nba");
    }
    ...
    public void m1776a(Context context, String str) {
        ...
        this.f1334y = al.af[C0220c.m1904a(this.f1334y, al.af)];
        this.f1335z = dataInputStream.readInt();
        this.f1335z = al.ai[C0220c.m1904a(this.f1335z, al.ai)];
        ...
        if (readInt == 1) {
            ...
            while (dataInputStream.readBoolean()) {
                ...
                while (it.hasNext()) {
                    agVar = (ag) it.next();
                    if (agVar.m1642a().equals(readUTF)) {
                        this.f1318i = agVar.m1643b();
                        this.f1319j = agVar.m1642a();
                    }
                }
                ...
                while (it.hasNext()) {
                    agVar = (ag) it.next();
                    if (agVar.m1642a().equals(readUTF)) {
                        this.f1320k = agVar.m1643b();
                        this.f1321l = agVar.m1642a();
                    }
                }
                ...
                while (it.hasNext()) {
                    agVar = (ag) it.next();
                    if (agVar.m1642a().equals(readUTF)) {
                        this.f1322m = agVar.m1643b();
                        this.f1323n = agVar.m1642a();
                    }
                }
                ...
                while (it.hasNext()) {
                    agVar = (ag) it.next();
                    if (agVar.m1642a().equals(readUTF)) {
                        this.f1324o = agVar.m1643b();
                        this.f1325p = agVar.m1642a();
                    }
                }
            }
            try {
                ...
                C0176a.m1106c("No pants available in this config.");
            }
        } else {
            if (dataInputStream.readBoolean()) {
                this.f1314e = dataInputStream.readUTF();
    ...
    public boolean m1780a(ah ahVar) {
        return m1763a(ahVar.m1672d(this.f1313d));
    }
    ...
    public boolean m1786b() {
        return this.f1311b == null && this.f1330u == 1.0f && this.f1331v == 1.0f && this.f1326q == 1.0f && this.f1327r == 1.0f && this.f1328s == 1.0f && this.f1329t == 1.0f && this.f1332w == 1.0f && this.f1333x == 1.0f && this.f1335z == al.f1191b.intValue() && ((this.f1334y == al.f1190a.intValue() || this.f1334y == -16777216) && m1764h(this.f1312c) && m1764h(this.f1313d) && m1764h(this.f1314e) && m1764h(this.f1315f) && m1764h(this.f1316g) && m1764h(this.f1317h) && m1764h(this.f1319j) && m1764h(this.f1321l) && m1764h(this.f1323n) && m1764h(this.f1325p));
    }

    public String m1787c() {
        boolean z = true;
    ...
    public void m1792d() {
        try {
            C0185i a = C0185i.m1177a();
            a.m1189a("Colors", "Hair Color", al.m1696c(this.f1334y), 0);
            a.m1189a("Colors", "Skin Color", al.m1695b(this.f1335z), 0);
