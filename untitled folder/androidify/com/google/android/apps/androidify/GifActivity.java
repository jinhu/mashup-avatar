...
public class GifActivity extends Activity {
    ...
    private void m1494a() {
        ...
        C0220c.m1912a("- Elapsed: " + (currentTimeMillis - this.f880c));
    ...
    protected void onCreate(Bundle bundle) {
        ...
        this.f878a = new ba(this);
        az a2 = a.m1656a();
        this.f878a.m1844a(a2, a);
        this.f878a.m1835a(400, 400);
        this.f878a.m1848b(0.75f);
        this.f879b = C0204a.m1596a((Context) this, (int) R.raw.anim_bodywave);
