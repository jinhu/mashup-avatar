...
class cv extends AsyncTask {
    final /* synthetic */ C0208e f1544a;
    final /* synthetic */ ShareActivity f1545b;

    cv(ShareActivity shareActivity, C0208e c0208e) {
    ...
    protected File m1940a(Void[] voidArr) {
        try {
            ba baVar = new ba(this.f1545b);
            baVar.m1844a(this.f1545b.f919o, this.f1545b.f918n);
            float c = this.f1545b.m1559c(this.f1545b.f909e.m1924a(this.f1545b.f923s));
            int i = (int) (800.0f * c);
            int i2 = (int) (c * 800.0f);
            baVar.m1835a(i, i2);
            ...
            while (((double) j) < this.f1544a.m1609b() && !isCancelled()) {
                ...
                baVar.m1841a(this.f1544a, (double) j);
                canvas.save();
