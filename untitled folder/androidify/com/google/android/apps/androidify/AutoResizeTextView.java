...
public class AutoResizeTextView extends TextView {
    ...
    private int m1407a(int i, int i2, ak akVar, RectF rectF) {
        if (!this.f796k) {
    ...
    private void m1412a(String str) {
        if (this.f797l) {
            ...
            getTextSize();
            super.setTextSize(0, (float) m1407a(i, (int) this.f790e, this.f798m, this.f787b));
        }
    }

    private static int m1413b(int i, int i2, ak akVar, RectF rectF) {
        int i3 = i2 - 1;
        int i4 = i;
        int i5 = i;
        while (i4 <= i3) {
            i5 = (i4 + i3) >>> 1;
            int a = akVar.m1691a(i5, rectF);
            if (a < 0) {
                i5++;
            } else if (a <= 0) {
                return i5;
