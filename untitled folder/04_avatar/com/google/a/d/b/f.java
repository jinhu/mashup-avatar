...
final class f {
    ...
    static void a(a aVar, int i, b bVar) {
        ...
        if (i3 != aVar.a()) {
            throw new h("Not all bits consumed: " + i3 + '/' + aVar.a());
        }
    }

    static void a(a aVar, com.google.a.d.a.a aVar2, c cVar, int i, b bVar) {
        a(bVar);
        a(cVar, bVar);
        a(aVar2, i, bVar);
        b(cVar, bVar);
    ...
    static void a(com.google.a.d.a.a aVar, int i, a aVar2) {
        if (g.b(i)) {
            int a = (aVar.a() << 3) | i;
            aVar2.a(a, 5);
            aVar2.a(a(a, 1335), 10);
            ...
            aVar2.b(aVar3);
            if (aVar2.a() != 15) {
                throw new h("should not happen but we got: " + aVar2.a());
            }
            return;
        }
    ...
    static void a(com.google.a.d.a.a aVar, int i, b bVar) {
        a aVar2 = new a();
        a(aVar, i, aVar2);
        for (int i2 = 0; i2 < aVar2.a(); i2++) {
            boolean a = aVar2.a((aVar2.a() - 1) - i2);
