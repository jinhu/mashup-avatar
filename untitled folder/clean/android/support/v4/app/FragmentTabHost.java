...
public class FragmentTabHost extends TabHost implements OnTabChangeListener {
    ...
    private C0003v m67a(String str, C0003v c0003v) {
        C0023u c0023u = null;
        int i = 0;
    ...
    protected void onAttachedToWindow() {
        ...
        for (int i = 0; i < this.f74a.size(); i++) {
            ...
            c0023u.f164d = this.f76c.m103a(c0023u.f161a);
            if (!(c0023u.f164d == null || c0023u.f164d.m41d())) {
                if (c0023u.f161a.equals(currentTabTag)) {
                    ...
                    c0003v.m72a(c0023u.f164d);
                }
            }
        }
        this.f80g = true;
        C0003v a = m67a(currentTabTag, c0003v);
        if (a != null) {
            a.m70a();
            this.f76c.m105b();
        }
