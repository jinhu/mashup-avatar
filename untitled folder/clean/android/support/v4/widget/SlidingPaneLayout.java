    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i7 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (c0114o.f387b) {
                    int min = (Math.min(paddingRight, (i6 - paddingLeft) - this.f355f) - i8) - (c0114o.leftMargin + c0114o.rightMargin);
                    this.f360k = min;
                    i9 = f ? c0114o.rightMargin : c0114o.leftMargin;
                    c0114o.f388c = ((i8 + i9) + min) + (measuredWidth / 2) > i6 - paddingLeft;
                    i5 = (int) (((float) min) * this.f358i);
                    i10 = i8 + (i9 + i5);
                    this.f358i = ((float) i5) / ((float) this.f360k);
                    i5 = 0;
                } else if (!this.f356g || this.f362m == 0) {
                    i5 = 0;
                    i10 = paddingRight;
                } else {
                    i5 = (int) ((1.0f - this.f358i) * ((float) this.f362m));
                    i10 = paddingRight;
                }
                if (f) {
                    i9 = (i6 - i10) + i5;
        ...
        if (this.f368s) {
            if (this.f356g) {
                ...
                for (i5 = 0; i5 < childCount; i5++) {
                    m760a(getChildAt(i5), 0.0f, this.f351b);
                }
            }
            m767a(this.f357h);
        }
